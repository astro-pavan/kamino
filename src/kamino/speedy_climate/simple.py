...
data_path = '/home/pt426/Code/kamino/src/kamino/speedy_climate/data/climate_runs/dataset_2d_v5.csv'
...
contour_filled = ax.tricontourf(p_co2_log, S / SOLAR_CONSTANT, T, levels=200, cmap='plasma')
# ax.scatter(p_co2_log, S / SOLAR_CONSTANT, c=T, cmap='plasma')
