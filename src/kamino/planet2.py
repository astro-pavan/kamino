...
class Planet:
    ...
    def _compute_fluxes_and_derivatives(self, Y, dt):
        ...
        # Deep burial (Get the target equilibrium shift from PHREEQC)
    ...
    def time_evolve_to_steady_state(self, dt=100*YR, tol=5e-3, check_every=100, max_steps=30000, dt_max=200000*YR, dt_min=100*YR, output_dir='.', b_ocean_init: dict | None = None, verbose: bool=False):
