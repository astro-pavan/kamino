...
if __name__ == "__main__":
    ...
    # Sweep 4: reverse weathering

    run_sweep(instellation, outgassing_default, crust_production_rate_default, ocean_depth_default, reverse_weathering, crust_composition_default, f_HT_default)
