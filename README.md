...
KAMINO is a model for simulating the climate stability of ocean exoplanets, defined as planets that are entirely covered in oceans. It has three subpackages: speedy_climate, seafloor_weathering, ocean_chemistry.
...
seafloor_weathering uses the weathering model from [Hakim et al. (2021)](https://iopscience.iop.org/article/10.3847/PSJ/abe1b8/meta) to calculate the producion of alkalinity from seafloor weathering.
